...
export const CHAT_HEADER: string = `PRESIDENT AI`;
export const MESSAGE_PLACEHOLDER: string = `[MESSAGE PLACEHOLDER]`;
export const FOOTER_MESSAGE: string = `Customized by Karthik Konuru @ UNC Chapel Hill`;
export const CLEAR_BUTTON_TEXT: string = `CLEAR`;
export const PAGE_TITLE: string = `President AI`;
